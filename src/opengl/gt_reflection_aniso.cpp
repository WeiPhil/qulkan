...
GTReflectionAniso::GTReflectionAniso(const char *viewName, int initialRenderWidth, int initialRenderHeight)
...
void GTReflectionAniso::initHandles() {
...
void GTReflectionAniso::initProgram() {
...
void GTReflectionAniso::initBuffer() {
...
void GTReflectionAniso::initTexture() {
...
void GTReflectionAniso::initVertexArray() {
...
void GTReflectionAniso::initFramebuffer() { return; }

void GTReflectionAniso::initOpenGLOptions() {
    glEnable(GL_BLEND);
    glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
}

void GTReflectionAniso::init() {
...
void GTReflectionAniso::render(int actualRenderWidth, int actualRenderHeight) {
