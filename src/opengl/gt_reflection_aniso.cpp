...
GTReflectionAniso::GTReflectionAniso(const char *viewName, int renderWidth, int renderHeight) : Qulkan::RenderView(viewName, renderWidth, renderHeight) {
...
void GTReflectionAniso::initFramebuffer() {
...
ImTextureID GTReflectionAniso::render() {
