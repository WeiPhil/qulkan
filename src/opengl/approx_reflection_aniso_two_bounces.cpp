...
ApproxReflectionAnisoTwoBounces::ApproxReflectionAnisoTwoBounces(const char *viewName, int renderWidth, int renderHeight)
...
void ApproxReflectionAnisoTwoBounces::initFramebuffer() {
...
ImTextureID ApproxReflectionAnisoTwoBounces::render() {
