...
GTReflectionAnisoTwoBounces::GTReflectionAnisoTwoBounces(const char *viewName, int renderWidth, int renderHeight)
...
void GTReflectionAnisoTwoBounces::initFramebuffer() {
...
ImTextureID GTReflectionAnisoTwoBounces::render() {
