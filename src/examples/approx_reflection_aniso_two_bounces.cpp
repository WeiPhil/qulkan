...
ApproxReflectionAnisoTwoBounces::ApproxReflectionAnisoTwoBounces(const char *viewName, int initialRenderWidth, int initialRenderHeight)
...
void ApproxReflectionAnisoTwoBounces::initProgram() {
...
void ApproxReflectionAnisoTwoBounces::initBuffer() {
...
void ApproxReflectionAnisoTwoBounces::readFileTo(std::ifstream &in, std::vector<float> &data) {
...
void ApproxReflectionAnisoTwoBounces::initTexture() {
...
void ApproxReflectionAnisoTwoBounces::initVertexArray() {
...
void ApproxReflectionAnisoTwoBounces::initFramebuffer() { return; }

void ApproxReflectionAnisoTwoBounces::initOpenGLOptions() {
    glEnable(GL_BLEND);
    glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
}

void ApproxReflectionAnisoTwoBounces::init() {
...
void ApproxReflectionAnisoTwoBounces::clean() {
...
void ApproxReflectionAnisoTwoBounces::render(int actualRenderWidth, int actualRenderHeight) {
