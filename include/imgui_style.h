...
namespace ImGui
{
    ...
    void StyleColorsSober(ImGuiStyle* dst){
        ...
        colors[ImGuiCol_CheckMark]              = ImVec4(0.35f, 0.35f, 0.40f, 1.00f);
        colors[ImGuiCol_SliderGrab]             = ImVec4(0.42f, 0.51f, 0.63f, 1.00f);
        colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.26f, 0.59f, 0.98f, 1.00f);
        colors[ImGuiCol_Button]                 = ImVec4(0.32f, 0.51f, 0.64f, 0.40f);
        colors[ImGuiCol_ButtonHovered]          = ImVec4(0.24f, 0.41f, 0.61f, 1.00f);
        ...
        colors[ImGuiCol_Tab]                    = ImVec4(0.27f, 0.30f, 0.34f, 0.86f);
        colors[ImGuiCol_TabHovered]             = ImVec4(0.29f, 0.41f, 0.54f, 0.80f);
        colors[ImGuiCol_TabActive]              = ImVec4(0.23f, 0.37f, 0.39f, 1.00f);
        colors[ImGuiCol_TabUnfocused]           = ImVec4(0.07f, 0.10f, 0.15f, 0.97f);
        colors[ImGuiCol_TabUnfocusedActive]     = ImVec4(0.26f, 0.35f, 0.46f, 1.00f);
