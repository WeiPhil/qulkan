...
namespace OpenGLExamples {
    ...
    class Textures : public Qulkan::RenderView {
      ...
      public:
        Textures(const char *viewName = "OpenGL Example: Textures", int initialRenderWidth = 1920, int initialRenderHeight = 1080);
        virtual ~Textures() { clean(); }
